...
?>
	<main id="primary" class="site-main">
		<!-- Hero -->
		<div class="container">
			<div class="row d-sm-flex align-items-center justify-content-between w-100 " style="height: 70vh;">
			...
			<span class="text-secondary text-uppercase">
				<?php echo esc_html( get_theme_mod( 'storebase_hero_subheadline', 'Subheadline' ) ); ?>
					...
					<h2 class="display-4 my-4 font-weight-bold"
						style="color: #9B5DE5;"><?php echo esc_html( get_theme_mod( 'storebase_hero_headline', 'Enter Your Headline Here' ) ); ?>
					</h2>
					<a href="<?php echo esc_url( get_theme_mod( 'storebase_hero_button_link', '#' ) ); ?>"
				...
				<div class="col-md-8 h-100 clipped"
					style="min-height: 350px;
							background-image: url(<?php echo esc_url( get_theme_mod( 'storebase_hero_bg_image' ) ); ?>);
