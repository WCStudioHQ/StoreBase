        ...
        <header class="header_section">
            <div class="container">
                <nav class="navbar navbar-expand-lg custom_nav-container ">
                    <a class="navbar-brand" href="index.html" style="color: black; font-weight: bold; font-size: 30px;">
                        StoreBase
<!--                        <img width="250" src="images/logo.png" alt="#" />-->
        ...
        <section class="slider_section ">
            <div class="slider_bg_box">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/slider-bg.jpg" alt="slider image">
